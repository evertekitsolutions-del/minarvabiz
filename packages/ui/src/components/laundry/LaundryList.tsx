...
export function LaundryList({ orders, onAddOutsourced, onAddIroning, onCreate, onSearch, onSelect }: { orders: LaundryOrder[]; onAddOutsourced?: () => void; onAddIroning?: () => void; onCreate?: (mode: "outsourced" | "in_house_ironing") => void; onSearch?: (q: string) => void; onSelect?: (o: LaundryOrder) => void }) {

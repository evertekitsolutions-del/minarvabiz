...
export function OfflineModulesPanel({
  ...
  if (activeNav === "suppliers") {
    ...
    return <><SupplierList suppliers={suppliers} onSearch={setSupplierQuery} onAdd={() => { setSupplierError(null); setSupplierForm({ name: "", company: "", phone: "", category: "" }); setSupplierOpen(true); }} onPay={openPayment} />

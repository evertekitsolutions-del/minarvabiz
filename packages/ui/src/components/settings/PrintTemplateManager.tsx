        ...
        {draft && (
          <div className="space-y-5 rounded-xl border border-slate-200 p-4">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <FormField label="Signature label"><input className={inputClass} value={draft.signatureLabel} onChange={(e) => setDraft({ ...draft, signatureLabel: e.target.value })} /></FormField>

...
assert.doesNotMatch(route, /api\\.github\\.com|releases\\/latest/);
assert.match(route, /package\\.json/);
assert.match(route, /releases\\/download/);
assert.match(route, /\\.exe\\.sha256/);
assert.match(route, /rootPackage\\.version/);

...
reset();
r=orders.createOrder({customerId:"c",serviceType:"ladies_tailoring",price:100,advance:25});
...
console.log("Service order accounting: cash advance, AR, service revenue, bulk/T-shirt pricing, validation, immutable automatic journals, permissions, outbox and no historical backfill PASS");

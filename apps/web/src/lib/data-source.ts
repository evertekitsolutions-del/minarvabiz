  ...
  try {
    ...
    registerRemoteWriter({
      ...
      upsertSupplier: async (supplier) => {
        const row = { name: supplier.name, company: supplier.company ?? null, phone: supplier.phone ?? null, category: supplier.category ?? null, opening_balance: supplier.openingBalance ?? 0, outstanding_balance: supplier.outstandingBalance ?? 0, notes: supplier.notes ?? null, updated_at: supplier.updatedAt, branch_id: supplier.branchId ?? null };

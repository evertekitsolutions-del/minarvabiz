...
async function main() {
  ...
  try {
    ...
    await assertMain(ws, "RETURNS", ["Returns, Refunds & Exchanges", "New Return", "New Exchange"]);
    ...
    await assertMain(ws, "RETURN_RECORDED", ["Returns, Refunds & Exchanges", "QA POS Customer"]);

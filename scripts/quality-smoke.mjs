...
assert(persistence.includes("SNAPSHOT_VERSION = 8"), "Domain snapshot version must include stock-transfer approvals, operations, print settings, and held POS sales");
